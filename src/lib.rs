...
#[derive(Debug)]
pub struct ChainPackageProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainPackageProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainPackage processing");
    
    let mut processor = ChainPackageProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainPackageProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainPackageProcessor::new(false);
